...
if (costs > revenue):
    print(f"Финансовый результат - убыток. Ее величина: {costs - revenue}")
else:
    ...
    print(f"Рентабельность выручки = {(revenue -costs) / costs * 100}")
    employees = int(input("Введите численность сотрудников фирмы: "))
    print(f"Прибыль фирмы в расчете на одного сотрудника = {(revenue - costs)/employees}")